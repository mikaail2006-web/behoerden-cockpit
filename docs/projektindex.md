...
| `Restore-Test-Behörden-Cockpit.command` | letztes lokales Backup auf Wiederherstellbarkeit und Ausschluesse pruefen |
...
| `scripts/test-local-backup-restore.mjs` | letztes lokales Backup strukturell pruefen |
