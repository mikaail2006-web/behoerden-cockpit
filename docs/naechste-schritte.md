...
- In der App unter `Automationen > Produktiv-Integrationen` die Integrationspunkte abarbeiten
- WhatsApp Business Provider verbinden
- Template freigeben lassen
- Testfrist mit Empfaenger-Opt-in senden
- In der App `Automationen > Unkritischer Produktiv-Testlauf` nutzen
- Versand im `Audit_Log` pruefen

## 2. n8n-KI-Endpunkt produktiv verbinden

- In der App den Punkt `KI/OCR-Endpunkt hinterlegt` erst nach echtem Credential abhaken
...
- erfolgreichen Testlauf in der App protokollieren
