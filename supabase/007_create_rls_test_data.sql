-- Behoerden-Cockpit RLS test data
-- Fuer das Testprojekt nach 006_create_test_auth_users.sql ausfuehren.

with constants as (
  select
    'b0000000-0000-4000-9000-000000000001'::uuid as tenant_id,
    'a0000000-0000-4000-9000-000000000001'::uuid as admin_id
),
cleanup as (
  delete from public.cases
  where authority = 'Deutsche Rentenversicherung Test'
     or next_step = 'RLS-Testdaten pruefen'
  returning id
),
test_case as (
...
select 'cases' as table_name, count(*) as rows from public.cases where tenant_id = 'b0000000-0000-4000-9000-000000000001'
union all
select 'documents', count(*) from public.documents where tenant_id = 'b0000000-0000-4000-9000-000000000001'
union all
select 'deadlines', count(*) from public.deadlines where tenant_id = 'b0000000-0000-4000-9000-000000000001'
union all
select 'tasks', count(*) from public.tasks where tenant_id = 'b0000000-0000-4000-9000-000000000001'
union all
select 'audit_log', count(*) from public.audit_log where tenant_id = 'b0000000-0000-4000-9000-000000000001';
