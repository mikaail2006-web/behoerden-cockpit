...
- [ ] Upload-Hinweis zeigt `Preflight vollstaendig`
...
Wenn trotz offener Preflight-Liste ein Dokument geprueft wird, fragt die App vorher nach einer Bestaetigung. Wird fortgefahren, schreibt sie einen Audit-Eintrag mit dem aktuellen Preflight-Stand.
